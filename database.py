...
class User(Base):
    ...
    disabilityCategoriesId = Column(Integer, ForeignKey('DisabilityCategorie.id'))
    civilCategoryId = Column(Integer, ForeignKey('CivilCategory.id'))
    pensionAmount = Column(Integer)
    familyStatusId = Column(Integer, ForeignKey('FamilyStatus.id'))
